...
Label(text = 'Rock Paper Scissors Game', font = font.Font(size = 24), bg = '#FFE873').pack()
...
winner_label = Label(text = "Let's start the Game...", fg = 'blue', bg = '#FFE873', font = font.Font(size = 13), pady = 8)
winner_label.pack()
...
rock_btn = Button(input_frame, text = 'Rock', width = 15, bd = 0, bg = 'green', pady = 5, command = lambda: player_choice(options[0]))
...
scissors_btn = Button(input_frame, text = 'Scissors', width = 15, bd = 0, bg = 'dark blue', pady = 5, command = lambda: player_choice(options[2]))
